...
// The macro “#define VALID_ZERO_PAYLOAD -2” is used as a special return value from 
// our PDU receiving function (recvBuf) to indicate that a valid packet was received 
